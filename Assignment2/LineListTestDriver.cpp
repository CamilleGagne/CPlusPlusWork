...
int main()
{
	const char * filename_a{ "C:/Users/cam_ga/Desktop/Assignment1/input_a.txt" }; //Changed from "C:\\input_a.txt"
	const char * filename_b{ "C:/Users/cam_ga/Desktop/Assignment1/input_b.txt"  }; //Changed from "C:\\input_b.txt"
...
void test_linked_list_operations(LineList& line_list)
{
	...
	Line lastline = line_list.get(line_list.size()); // get, copy ctor  // = line 1
	line_list.pop_back();                            // pop_back
	if (line_list.empty()) return;                   // empty


	Line line1 = line_list.get(1);                   // get     // line second
	line_list.pop_front();                           // pop_front()
	if (line_list.empty()) return;                   // empty


	line1 = line_list.get(1);                        // get, operator=  //line 20
	line_list.pop_front();                           // pop_front();
